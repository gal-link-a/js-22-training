...
//   const uniqueGenres = allGenres.filter((genere, index ,allGenres) =>allGenres.indexOf(genere) === index);
...
// console.log('getUsersWithEyeColor', getUsersWithEyeColor(users, 'blue'));
...
// console.log('getUsersWithAge',getUsersWithAge(users, 20, 25));
...
// console.log('getUsersWithFriend',getUsersWithFriend(users, 'Goldie Gentry'));
...
// console.log(playtimes);/* вывела в массив все значения из объекта*/

// const totalPlayTime = playtimes.reduce((acc, player) => acc + player, 0);

// console.log(totalPlayTime);/*с помощью reduce получила сумму 2692
//                              acc это аккумулятор предыдущих значений*/

// const averagePlayTime = totalPlayTime / playtimes.length;

// console.log(averagePlayTime); /* получаю среднее время игры всех учасников*/
...
//     users.reduce((acc, player) => acc + player.balance, 0);
